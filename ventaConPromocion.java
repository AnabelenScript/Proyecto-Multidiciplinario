...
public class ventaConPromocion extends ventaProducto {
    ...
    public ventaConPromocion(ArrayList<Productos> listaProductos, float cuentaTotal) {
    ...
    protected void realizarPago() {
        ...
        for (int i = 1; i < listaProductos.size(); i++) {
            if (listaProductos.get(i).getcostoProducto() < listaProductos.get(indiceProductoMasBarato).getcostoProducto()) {
